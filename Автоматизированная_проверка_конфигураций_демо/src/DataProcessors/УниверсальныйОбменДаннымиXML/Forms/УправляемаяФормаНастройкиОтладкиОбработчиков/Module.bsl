...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокФормы = СтрШаблон(НСтр("ru='Настройка отладки обработчиков при %1 данных'"), Событие);
	Заголовок = ЗаголовокФормы;
	
	Событие = ?(Параметры.ОбработчикиСобытийЧитаемИзФайлаПравилОбмена, НСтр("ru='выгрузки'"), НСтр("ru='загрузки'"));
	ЗаголовокКнопки = СтрШаблон(НСтр("ru='Сформировать модуль отладки %1'"), Событие);
