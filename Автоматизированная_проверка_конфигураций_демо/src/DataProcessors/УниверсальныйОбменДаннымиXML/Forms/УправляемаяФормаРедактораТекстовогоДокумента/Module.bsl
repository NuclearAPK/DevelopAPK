...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьПолеТекстовогоДокумента(ПолеОбработчикиСобытий, "ПолеОбработчикиСобытий",
		Параметры.ИмяВременногоФайлаОбработчиковСобытий);
	ЗаполнитьПолеТекстовогоДокумента(ПолеОшибкиВыгрузки, "ПолеОшибкиВыгрузки",
		Параметры.ИмяВременногоФайлаПротоколаОбмена);
